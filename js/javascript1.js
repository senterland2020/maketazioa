...
let adina = prompt('Zein da zure adina?');//adina aldagaian, bigarren galderaren erantzuna gordetzen da.
...
document.getElementById("erantzuna").innerHTML = "<h2>Ongi etorri " + izena + " !!! Zure adina, " + adina + " urtekoa da.<h2/><h3>" + urtea +" urtean jaio zinen</h3>";
}
